...
const navItems = [
    { path: '/dashboard/admin',           label: 'Overview',          icon: 'ri-pie-chart-2-line' },
    { path: '/dashboard/add-product',     label: 'Add Product',       icon: 'ri-add-box-line' },
    { path: '/dashboard/manage-products', label: 'Manage Products',   icon: 'ri-box-3-line' },
    { path: '/dashboard/users',           label: 'All Users',         icon: 'ri-group-line' },
            ...
            <div className='px-6 pt-6 pb-4 border-b border-white/5'>
                ...
                <div className='mt-2'>
                    <span className='inline-flex items-center gap-1.5 text-[10px] font-semibold tracking-widest uppercase px-2 py-0.5 rounded-full'
                        ...
                        <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#ed3849', display: 'inline-block' }} />
                        Admin Panel
                    </span>
                </div>
            </div>
